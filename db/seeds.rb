...
Product.create(:name => "Classic White Bike", :description => "Very nice, old styled city bike.", :colour => "white", :price => "50", :image_url => "bike3.jpg")
...
User.create(:first_name => "Max", :last_name => "Mustermann", :email => "maxmustermann@example.de", :password => "Christiane", :password_confirmation => "Christiane" :admin => "true")
